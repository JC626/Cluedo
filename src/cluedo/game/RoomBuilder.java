...
class RoomBuilder 
{
	...
	private int[] KITCHEN_EXIT = new int[] { 4, 7, 23, 21 };

	private int[] BALLROOM = new int[] { 
			          10,1, 11,1, 12,1, 13,1,
	...
	private int[] BALLROOM_EXIT = new int[] { 7, 5, 9, 8, 14, 8, 16, 5 };

	private int[] CONSERVATORY = new int[] { 
	...
	private int[] CONSERVATORY_ENTRANCE = new int[] { 18, 4, 22, 5 };
	private int[] CONSERVATORY_EXIT = new int[] { 18, 5, 0, 19 };

	private int[] DINING_ROOM = new int[] { 
			0,9,  1,9,  2,9,  3,9,  4,9,
	...
	private int[] BILLIARD_ROOM = new int[] { 
